...
import { createProduct, getAllCategories } from "../src/api/crud";
import "./EditProductPortal.css";

const AddProductPortal = ({ onClose }) => {
  ...
  return createPortal(
    <div className="edit-portal-overlay" onClick={onClose}>
      <div className="edit-portal-modal" onClick={(e) => e.stopPropagation()}>
        <h2 className="edit-portal-title">Add New Product</h2>
        <form className="edit-portal-form" onSubmit={handleSubmit}>
          ...
          {isError && <p className="portal-error">Failed to create product.</p>}
...
export default AddProductPortal;
